<p align="center">
  <img src="src/main/resources/logo.png" alt="Language Whitelist icon" width="160">
</p>
...
This version supports Minecraft 1.21.4 on NeoForge.
...
| --- | --- |
| Minecraft | 1.21.4 |
| NeoForge | 21.4.0 or newer for Minecraft 1.21.4 |
...
Change the JDK path if Java 21 is installed in a different folder.
