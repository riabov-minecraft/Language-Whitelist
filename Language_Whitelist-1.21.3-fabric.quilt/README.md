...
This version supports Minecraft 1.21.3 on Fabric Loader and Quilt Loader. Fabric API is not required.
...
| Quilt Loader | A version compatible with Minecraft 1.21.3 |
| Java at runtime | 21 or newer |

## Installation

1. Install Fabric Loader or Quilt Loader for Minecraft 1.21.3.
