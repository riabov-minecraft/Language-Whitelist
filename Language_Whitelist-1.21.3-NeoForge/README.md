...
This version supports Minecraft 1.21.3 on NeoForge.
...
| --- | --- |
| Minecraft | 1.21.3 |
| NeoForge | 21.3.96 or newer |
| Java at runtime | 21 or newer |

## Installation

1. Install NeoForge for Minecraft 1.21.3.
...
```text
langwhitelist-client.toml.broken-20260727-120000
```
